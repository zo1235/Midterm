...
public class MainClass {
  ...
  private PatientForm createPatientForm(JPanel bottomPanel) {
   ...
   private class PatientForm extends javax.swing.JPanel implements ActionListener{

        private User User;
        JPanel bottomPanel;
        private JLabel referenceLabel;
    /**
     * Creates new form PatientForm_10
     */
    public PatientForm(JPanel bottomPanel) {
        initComponents();
    ...
    private void submitbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitbuttonActionPerformed
       ...
       String Picture = null;
        ...
        CityForm viewObject = new CityForm(User,bottomPanel,scaledIcon);
